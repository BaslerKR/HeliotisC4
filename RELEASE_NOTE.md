...
- Normalize legacy `AcquisitionStart` through the selector-dependent `TriggerSelector`/`TriggerMode` controls, restore the original selector cursor, and treat its absence on newer firmware as compatible.
